...
export default function BedroomPage() {
  ...
  return (
    <main className="min-h-screen bg-amber-50 p-4 md:p-8 flex flex-col">
      {/* HEADER with date + subtle animation */}
      <header className="mb-8 text-center">
        <h1 className="text-3xl md:text-5xl font-serif text-stone-800 animate-pulse"
            style={{ animationDuration: '3s' }}>
          Bedroom — still dreaming
        </h1>
        <p className="mt-2 text-stone-500 text-sm tracking-widest uppercase">
          {date}
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 border border-amber-100
          ...
          <h2 className="text-xl font-semibold text-stone-700 mb-3">pensées</h2>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 border border-amber-100
                        hover:shadow-lg transition-shadow duration-300">
          <h2 className="text-xl font-semibold text-stone-700 mb-3">cartes</h2>
          <p className="text-stone-500 text-sm leading-relaxed">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 border border-amber-100
                        hover:shadow-lg transition-shadow duration-300">
          <h2 className="text-xl font-semibold text-stone-700 mb-3">mémoires</h2>
          <p className="text-stone-500 text-sm leading-relaxed">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 border border-amber-100
                        hover:shadow-lg transition-shadow duration-300">
          <h2 className="text-xl font-semibold text-stone-700 mb-3">veille</h2>
          <p className="text-stone-500 text-sm leading-relaxed">
